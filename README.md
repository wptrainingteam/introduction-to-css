...
There are different ways to target a specific element in CSS depending upon the element itself. Below are the most common ways to target an element.
    ...
    Assume you have a <p> tag with class 'text-small' which will look something like this '<p class="text-small">' and you want its 'font-size' to be '12px'. You will write it as below:
